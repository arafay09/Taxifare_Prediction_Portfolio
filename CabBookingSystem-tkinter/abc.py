# -*- coding: utf-8 -*-
"""
Created on Wed May 25 22:15:07 2022
...
# -*- coding: utf-8 -*-
"""
Created on Tue May 24 21:55:37 2022
...
class travel:
    ...
    def __init__(self,root):
        self.root = root
        self.root.title("Taxi Fare booking App System")
    ...
    #==========================================Define Functiom==================================================
        ...
        def Receiptt():
            if reset_counter == 0 and Firstname.get()!="" and Surname.get()!="" and Address.get()!="" and Postcode.get()!="" and Mobile.get()!="" and Telephone.get()!="" and Email.get()!="":
                ...
                a= pd.DataFrame({'Receipt Ref':[Receipt_Ref.get()] , 
                                 'Date':[DateofOrder.get()] , 'Cab No ' : [Receipt_Ref.get()] ,
                                 'Firstname':[Firstname.get()] ,'SurName' : [Surname.get()] , 
                                 'Address' : [Address.get()] , 'PostalCode '  : [Postcode.get()] , 
                                 'Telephone' :[Telephone.get()] , 'Mobile No ' : [Mobile.get()] , 
                                 'Email'  : [Email.get()] , 'Car' : ["Mini Ac /Bussiness/Luxery"] , 
                                 'Payment' : [PaidTax.get()], 'Subtotal' : [SubTotal.get()], 
                                 'TotalCost ' : [TotalCost.get()]
                                 
                                 
                                 })
                
                a.to_csv('D:/CabBookingSystem-tkinter/output1.csv',index=False)
        ...
        def Kilo():
            ...
            data=pd.read_excel('E:/5th Semester/AI Project/cabname1.xlsx')
            print(data)
            print("======== ++++++++++++++ ====================")
            dataa=pd.read_csv('D:/CabBookingSystem-tkinter/output1.csv')
           ...
           # print(data.shape)
            ...
            car_data=pd.read_excel('E:/5th Semester/AI Project/cabname1.xlsx')
            car_data2=pd.read_csv('D:/CabBookingSystem-tkinter/output1.csv')
            print(car_data2)
            print(car_data2['Receipt Ref'].value_counts())
            print(car_data2['Car'].value_counts())
            print(car_data2['TotalCost '].value_counts())

            distance_type=car_data2['Receipt Ref'] 
            destination_type=car_data2['Car'] 
            source_type=car_data2['TotalCost ']
            price_type=car_data2['Subtotal']
        
            distance_type=car_data['distance'] 
            destination_type=car_data['destination'] 
            source_type=car_data['Source']
            price_type=car_data['Price']
            ...
            if var2.get() == 0:
                ...
                if varl1.get() == 'Defence':
                    switch ={"Gulistan-e-johar": 10,"Gulshan-e-iqbal": 8,"North Nazimabad":6,"Defence": 0}
                    ...
                    plt.title('Correlation b/w column')
                    plt.show()
                    
                  
                    
                elif varl1.get() == 'Gulistan-e-johar':
                    switch ={"Gulistan-e-johar": 0,"Gulshan-e-iqbal": 2,"North Nazimabad":5,"Defence": 10}
                    Km.set(switch[varl2.get()])
                   ...
                   #using Regration
                ...
                elif varl1.get() == 'Gulshan-e-iqbal':
                    switch ={"Gulistan-e-johar": 2,"Gulshan-e-iqbal": 0,"North Nazimabad":3,"Defence": 8}
                    Km.set(switch[varl2.get()])
                    ...
                    plt.title("Correlation Between Destination and Source")
                    print(sns.regplot(x='Car',y='TotalCost ',data=car_data2))
                ...
                elif varl1.get() == 'North Nazimabad':
        ...
        def Total_Paid():
            ...
            fig.suptitle('Pricing pool')
            plt.subplot(1,3,1)
            plt.bar(distance_type,price_type, color="royalblue")
            plt.xlabel("distance type")
            plt.ylabel("price ")
            plt.subplot(1,3,2)
            plt.bar(destination_type,price_type,color='red')
            plt.xlabel("destination")
            plt.subplot(1,3,3)
            plt.bar(source_type,price_type,color='purple')
            plt.xlabel('Price')
            plt.show()
   ...
   #================================================mainframe========================================================================
    ...
    #===============================================Cab Information==============================================================
        ...
        self.cboPickup['value']=('','Defence','North Nazimabad','Gulshan-e-iqbal','Gulistan-e-johar')
        self.cboPickup.current(0)
        ...
        self.cboDrop['value']=('','Gulistan-e-johar','Gulshan-e-iqbal','Defence','North Nazimabad')
        self.cboDrop.current(0)
    ...
    #==========================================================Cabselect=======================================================================
        ...
        self.chkStandard=Radiobutton(Book_Frame,text="Mini Cab",value=1,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=0, column=0, sticky=W)
        ...
        self.chkFordGalaxyd=Radiobutton(Book_Frame,text="Mini Ac Cab",value=2,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=1, column=0, sticky=W)
        ...
        self.chkFordMondeo = Radiobutton(Book_Frame,text="Premimium  Cab",value=3,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=2, column=0)
